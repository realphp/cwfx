...
class PublicController extends CommonController {
    ...
    */
    public function _initialize() {
        ...
        // 登录后不可访问的action
        $filterAction = array('public', 'indexLogin');
        if (in_array(ACTION_NAME, $filterAction) && $this->hasLogin()) {
            return $this->redirect('Index/index1');
        }
    }
    ...
    public function login() {
        $reloadUrl = U('Public/indexLogin');

//        if (empty($_POST['admin']['username'])) {
//            return $this->errorReturn('请填写用户名！', $reloadUrl);
//        }
//
